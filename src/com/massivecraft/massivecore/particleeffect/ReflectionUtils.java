...
public final class ReflectionUtils {
	 ...
	 *                                   specified parameter types cannot be
	 *                                   found
	 * @see DataType
	 ...
	 * @param packageType
	 *                           Package where the desired target class is
	 *                           located
	 * @param parameterTypes
	 *                           Parameter types of the desired constructor
	 ...
	 *                                    ClassNotFoundException If the desired
	 *                                    target class with the specified name
	 ...
	 *                      Target class
	 * @param arguments
	 *                      Arguments which are used to construct an object of
	 *                      the target class
	 * @return The instance of the target class with the specified arguments
	 * @throws InstantiationException
	 *                                       If you cannot create an instance of
	 *                                       the target class due to certain
	 *                                       circumstances
	 * @throws IllegalAccessException
	 *                                       If the desired constructor cannot
	 *                                       be accessed due to certain
	 *                                       circumstances
	 * @throws IllegalArgumentException
	 *                                       If the types of the arguments do
	 *                                       not match the parameter types of
	 *                                       the constructor (this should not
	 *                                       occur since it searches for a
	 *                                       constructor with the types of the
	 *                                       arguments)
	 ...
	 * @throws InstantiationException
	 *                                       If you cannot create an instance of
	 *                                       the desired target class due to
	 ...
	 *                                       specified arguments cannot be found
	 * @throws ClassNotFoundException
	 *                                       If the desired target class with
	 *                                       the specified name and package
	 *                                       cannot be found
	 * @see #getClass(String, PackageType)
	 ...
	 *         parameter types
	 * @throws NoSuchMethodException
	 *                                   If the desired method of the target
	 ...
	 *         and parameter types
	 * @throws NoSuchMethodException
	 *                                    If the desired method of the desired
	 *                                    target class with the specified name
	 *                                    and parameter types cannot be found
	 * @throws ClassNotFoundException
	 *                                    If the desired target class with the
	 *                                    specified name and package cannot be
	 *                                    found
	 * @see #getClass(String, PackageType)
	 ...
	 *                       Name of the desired method
	 * @param arguments
	 *                       Arguments which are used to invoke the desired
	 *                       method
	 * @return The result of invoking the desired method on the target object
	 * @throws IllegalAccessException
	 *                                       If the desired method cannot be
	 *                                       accessed due to certain
	 *                                       circumstances
	 * @throws IllegalArgumentException
	 *                                       If the types of the arguments do
	 *                                       not match the parameter types of
	 *                                       the method (this should not occur
	 *                                       since it searches for a method with
	 *                                       the types of the arguments)
	 * @throws InvocationTargetException
	 *                                       If the desired method cannot be
	 *                                       invoked on the target object
	 * @throws NoSuchMethodException
	 *                                       If the desired method of the class
	 *                                       of the target object with the
	 *                                       specified name and arguments cannot
	 *                                       be found
	 * @see #getMethod(Class, String, Class...)
	 ...
	 *                                       invoked on the target object
	 * @throws NoSuchMethodException
	 *                                       If the desired method of the
	 *                                       desired target class with the
	 *                                       specified name and arguments cannot
	 *                                       be found
	 * @throws ClassNotFoundException
	 *                                       If the desired target class with
	 ...
	 *                                  If the desired field of the given class
	 *                                  cannot be found
	 * @throws SecurityException
	 *                                  If the desired field cannot be made
	 *                                  accessible
	 */
	 ...
	 * @throws NoSuchFieldException
	 *                                    If the desired field of the desired
	 ...
	 *                                      feature the desired field
	 * @throws IllegalAccessException
	 *                                      If the desired field cannot be
	 *                                      accessed
	 * @throws NoSuchFieldException
	 *                                      If the desired field of the target
	 *                                      class cannot be found
	 * @throws SecurityException
	 *                                      If the desired field cannot be made
	 *                                      accessible
	 ...
	 * @throws IllegalArgumentException
	 *                                      If the target object does not
	 *                                      feature the desired field (should
	 *                                      not occur since it searches for a
	 *                                      field with the given name in the
	 *                                      class of the object)
	 * @throws IllegalAccessException
	 *                                      If the desired field cannot be
	 *                                      accessed
	 ...
	 *                      New value
	 * @throws IllegalArgumentException
	 *                                      If the type of the value does not
	 *                                      match the type of the desired field
	 * @throws IllegalAccessException
	 *                                      If the desired field cannot be
	 *                                      accessed
	 * @throws NoSuchFieldException
	...
	public enum PackageType {
		 ...
		 * @throws ClassNotFoundException
		 *                                    If the desired class with the
		 *                                    specified name and package cannot
		 *                                    be found
		 */
	...
	public enum DataType {
		 ...
		 *                      Primary class array
		 * @param secondary
		 *                      Class array which is compared to the primary
		 *                      array
